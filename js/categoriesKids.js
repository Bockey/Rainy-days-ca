...
function createHTMl(products) {
  const productsContainerKids = document.querySelector(".new-products-kids");
  productsContainerKids.innerHTML = "";

  products.forEach((product) => {
    if (product.categories[0].name === "kids") {
      productsContainerKids.innerHTML += `<div>
